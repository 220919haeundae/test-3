...
public class LotteryMenu {
	...
	public void insertObject() {
		...
		for(int i = 0; i < num; i++) {
			...
			int count1 = lc.getSet().size();
			lc.insertObject(new Lottery(name, phone));
			int count2 = lc.getSet().size();
			if(count1 == count2) {
				i--;
			}
		}
	...
	public void deleteObject() {
		System.out.println("삭제할 추첨 대상자 이름과 핸드폰 번호를 입력하세요.");
		System.out.print("이름 : ");
		String name = sc.nextLine();
	...
	public void sortedWinObject() {
		TreeSet<Lottery> ts = lc.sortedObject();
