...
public class ExceptionRun {
	 ...
	 * 				- IndexOutofBoundsException : 접근하려고 하는 인덱스가 참조하는 배열의 인덱스 범위를 벗어날 때
	 * 				- NullPointerException : 참조변수가 null인 경우 특정 변수나 메소드에 접근하려 할 때 발생
	 * 
	 *  * 예외처리 : 예외들이 발생되었을 때 해결하는 방법 -> 정상적으로 프로그램이 실행될 수 있도록 하는 것
	 *  
	 *  * 방법
	 *  	[1] 직접 처리 : try ~ catch문 사용
	 *  	[2] 위임(떠넘기기) : 메소드명 throws 예외명
	 */
...
//		}catch(IOException e) {}
		//2. 위임(떠넘기기)
		//		throws : 현재 위치에서 예외처리하지 않고 메소드를 호출한 위치로 예외를 떠넘긴다.
